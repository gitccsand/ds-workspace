...
//
    ...
    public static void main(String[] args) throws Exception {
        ...
        addData("tom", tableName, customerFamily, column1, value1);
        ...
        addData("tom", tableName, tradeFamily, column2, value2_1);
        ...
        getResultScann(tableName, start_rowkey, end_rowkey); //遍历查询tom的数据   
